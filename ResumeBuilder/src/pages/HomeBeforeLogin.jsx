...
const testimonials = [
  {
    ...
    company: "Google",
    image:
      "https://images.unsplash.com/photo-1494790108755-2616b612b1b1?w=150&h=150&fit=crop&crop=face",
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          <div className="lg:w-1/2 space-y-8">
            ...
            <p className="text-xl text-gray-600 leading-relaxed max-w-2xl">
              Create stunning, ATS-optimized resumes with our AI-powered
              platform. Get personalized suggestions, collaborate in real-time,
      ...
      <section id="features" className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            that stand out and get you hired faster than traditional resume
            builders.
          </p>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {additionalFeatures.map((feature, index) => (
              <div
                key={index}
                className="bg-white/80 backdrop-blur-sm p-6 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 group"
              >
      ...
      <section className="bg-gradient-to-r from-emerald-600 via-blue-600 to-purple-600 py-20 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl mb-10 text-white/90 max-w-2xl mx-auto leading-relaxed">
            Join over 50,000 professionals who've successfully created winning
            resumes with ResumeAI. Start building your future today with our
            AI-powered platform.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            <div className="space-y-4">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                The AI-powered resume builder that helps professionals create
                winning resumes and land their dream jobs faster.
              </p>
          ...
          <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              &copy; 2024 ResumeAI. All rights reserved. Built with ❤️ for job
              seekers worldwide.
            </p>
